...
Public Class frmHistorialLlamado
    ...
    Private Sub escuchaGrabacion(ByVal id As Integer, ByVal idLlamada As String, ByVal idCRM As String, ByVal fecha As String, ByVal nombreGrabacion As String)
        Dim dia As String
        Dim Mes As String
        Dim anio As String
        ...
        nomFinalcrm = Microsoft.VisualBasic.Right("00" + idCRM.ToString, 3).ToString
        Dim url As String

        url = "\\192.168.1.14\Audios_CRM\CRM_" + nomFinalcrm + "\" + anio.ToString + "\" + Mes.ToString + "\" + dia.ToString + "\" + nombreGrabacion + ".mp3"
        Process.Start(url)
    End Sub
